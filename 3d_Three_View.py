...
def generate_image(input_image):
    with open("3dview.json","r", encoding="utf-8") as file_json:
        prompt = json.load(file_json)


    prompt["14"]["inputs"]["seed"] = random.randint(1, 1500000000000000) #定义种子随机数1到1500000，json的参数传递给comfyUI
   
    prompt["153"]["inputs"]["seed"] = random.randint(1, 1500000000000000)
